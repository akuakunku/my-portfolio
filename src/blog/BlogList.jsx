  ...
  return (
    <div className="bg-gray-300 dark:bg-gray-900">
      <div className='text-center font-bold mb-4'>
        <h2 className="text-2xl md:text-3xl lg:text-4xl">MY BLOG</h2>
      </div>
        ...
        <AnimatePresence>
          ...
          >
            {posts.map((post) => (
              <motion.div
                key={post.id}
                className="bg-gray-200 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 p-4 rounded-lg shadow-lg hover:shadow-2xl transition-transform duration-300"
