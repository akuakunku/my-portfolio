...
const Header = ({ toggleTheme, theme, isAuthenticated, handleLogout }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-md">
      ...
      {menuOpen && (
        <motion.div
          className={`md:hidden fixed top-3/1 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white p-6 rounded-full w-64 h-64 flex flex-col items-center justify-center space-y-4`}
        ...
        >
          ...
          <Link
            to="/"
            className="flex items-center w-40 py-3 px-3 bg-gray-800 text-white rounded-lg text-sm font-medium justify-center gap-2 hover:bg-gray-700 transition-colors"
            onClick={handleMenuToggle}
          >
          ...
          <Link
            to="/admin-login"
            className="flex items-center w-40 py-3 px-4 bg-gray-800 text-white rounded-lg text-sm font-medium justify-center gap-2 hover:bg-gray-700 transition-colors"
            onClick={handleMenuToggle}
          >
          ...
          <a
            ...
            {isAuthenticated && (
              <button
                onClick={handleLogout}
                className="flex items-center w-40 py-3 px-4 bg-gray-800 text-white rounded-lg text-sm font-medium justify-center gap-2 hover:bg-red-500 transition-colors"
                aria-label="Logout"
              >
